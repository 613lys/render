...
.release td pre{margin:2px 4px;padding:3px 5px;font-size:10px;line-height:1}.release .add,.release .del,.release .hunk,.release .diff-file,.release .ctx{display:inline;margin:0;padding:0;line-height:1}
