...
.tab-pane{display:none;padding:12px}.tab-pane.active{display:block}.toolbar{padding:7px;color:var(--muted)}.table-wrap{overflow:auto;max-height:72vh;border:1px solid var(--line);border-radius:8px}
...
.release-version-bar{display:flex;align-items:center;gap:14px;padding:10px 18px;background:#f7fafc;border-bottom:1px solid var(--line)}.release-version-bar>div:not(.version-arrow){display:flex;align-items:center;gap:8px}.release-version-bar span{color:var(--muted);font-size:12px}.release-version-bar b{color:#174f6b;font:600 13px Consolas,monospace}.version-arrow{color:#6f8198;font-size:17px}
