...
th small{display:block;color:var(--yellow);margin-top:5px;font-weight:400}td{background:#fff}td pre{margin:4px 6px;padding:6px 8px;white-space:pre-wrap;word-break:break-word;font:11px/1.24 Consolas,"Cascadia Mono",monospace;background:#f8fafc;border:1px solid #e5ebf2;border-radius:6px;tab-size:2}
...
.field-matrix .field-path{position:sticky;left:0;z-index:2;background:#f6f9fc;padding:7px 9px;text-align:left;color:#35546d;font:11px/1.24 Consolas,monospace}.field-value{padding:7px 9px;font:11px/1.24 Consolas,monospace;white-space:pre-wrap;overflow-wrap:anywhere}.field-diff{color:#c12640;font-weight:700}.field-same{color:#34445d}.category-row th{position:sticky;left:0;background:#dfeef5;color:#175c73;text-align:left;padding:7px 10px;font-size:11px;letter-spacing:.02em}.file-head{color:#526d83!important;overflow-wrap:anywhere}.raw-yaml-row details{margin:6px}.raw-yaml-row summary{cursor:pointer;color:#176a8d;font-weight:600;padding:5px}.raw-yaml-row pre{max-height:420px;overflow:auto}
.env-matrix td pre{margin:4px 6px;padding:6px 8px;font-size:11px;line-height:1.24}.env-matrix .row-title{padding:6px 8px}.field-matrix .field-path{padding:4px 7px;line-height:1.24}.field-matrix .field-value{padding:4px 7px;line-height:1.24}.field-matrix .category-row th{padding:4px 8px;font-size:11px}.field-matrix details{margin:3px}.field-matrix details summary{padding:3px}
...
.release td pre{margin:4px 6px;padding:6px 8px;font-size:11px;line-height:1.24}.release .add,.release .del,.release .hunk,.release .diff-file,.release .ctx{display:inline;margin:0;padding:0;line-height:1.24}
